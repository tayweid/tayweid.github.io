...
<p class="subheader">Proportional changes provide interpretable coefficients: $g_Y = \text{%}\Delta Y_t = \frac{\text{Y}_t - \text{Y}_{t-1}}{\text{Y}_{t-1}} = \frac{\Delta \text{Y}_t}{\text{Y}_{t-1}}$</p>

...
ax.annotate('$\\beta_0$ (Base wage)', xy=(-0.2, base_wage_female/2), 
            xytext=(-0.6, base_wage_female*0.5), fontsize=12,
...
ax.annotate('$\\beta_1$ (Gender Gap)', xy=(-0.2, base_wage_female+gender_gap/2), 
            xytext=(-0.6, base_wage_female+gender_gap/2), fontsize=12,
            arrowprops=dict(arrowstyle='->', color='black'))
...
2. **Use Model 2 (Fixed Effect) when:**
...
3. **Use Model 3 (Interaction Only) when:**

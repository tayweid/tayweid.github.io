...
## Random Variables: Known Distribution
<p class="subheader"> Example: Manufaturing Errors </p>

Manufacturing errors of a part follow a normal distribution *(in cm)* with:
...
- Multiple independent factors contribute to each error.
...
2. How many parts will have errors greater than 1/2 cm?
...
## Random Variables
<p class="subheader"> What is the distribution of a dataset?</p>

...
The diagnostic tools from 4.3 still apply: residual plots, checks for linearity, homoskedasticity, normality, and independence. The only thing that changes is the complexity of the model.

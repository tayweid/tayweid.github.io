...
## Cross-Sectional Categorical Data
<p class="subheader">Comparing categorical values across entities</p>
...
*> Categorical variables: values that represent groups or categories (state, status, sector)*

. . .

*> Key question: How are entities distributed across categories?*

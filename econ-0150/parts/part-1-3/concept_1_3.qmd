...
## But Wait: Are These Prices Comparable?
<p class="subheader">Let's zoom out even further...</p>
...
*> for now, let's focus on seasonal patterns within the trend*
...
| Block | New in 1.3 |
|-------|------------|
| Variables | (numerical reinforced) |
| Structures | time series |
| Operations | group by period |
| Visualizations | line plot, multi-boxplot |

. . .

*> Next: What if we want to transform the values themselves?*

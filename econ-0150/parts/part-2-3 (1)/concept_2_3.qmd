...
## Part 2.3 | Panel Data Visualization
...
::: {.incremental}
- Overlapping histograms are hard to read when comparing groups
- **Faceting** separates each group into its own panel for easy comparison
- **Line graphs** simplify multiple categories on a single plot
- Both techniques work well with **panel data** (repeated observations across groups)
:::
...
## Exercise 2.3 | Faceted Histogram
...
## Exercise 2.3 | Count Hourly by Shop
<p class="subheader">Q. Which shift is the busiest?</p>

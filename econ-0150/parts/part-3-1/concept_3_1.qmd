...
## PDFs and CDFs
<p class="subheader">Two ways to describe a probability distribution.</p>

:::: {.columns}
::: {.column width="50%"}

**PDF**: the height of $f(x)$ at each value.
...
plt.fill_between(x, y, alpha=0.15, color='blue')
plt.xlabel('x')
plt.ylabel('f(x)')
plt.yticks([])
...
**CDF**: the area under $f(x)$ up to each value — $P(X \leq x)$.

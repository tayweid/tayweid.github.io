...
b) What is the probability of waiting more than 15 minutes? You can reason this out from the shape of the distribution, then verify with `stats.uniform.cdf()`.

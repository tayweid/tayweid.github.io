...
<p class="subheader">We've built two models — and now we need a third.</p>
...
*> The regression framework doesn't care whether $x$ is continuous or binary. Code the group as 0 and 1, and fit the same model.*
...
<p class="subheader">Same test, different language.</p>

<br>

The math we just did — estimating the difference between group means, building its sampling distribution, testing whether it's zero — is exactly a **two-sample t-test**.
...
*> Regression is more general — it can handle continuous predictors, multiple groups, and control variables all at once.*

. . .

*> The two-sample t-test is a special case of the GLM.*
...
**Intercept-Only Model**: Continuous outcome variable ($y$) with only an intercept

$$y = \beta_0 + \varepsilon$$

. . .

**Numerical Predictor**: Continuous outcome variable ($y$) with a continuous predictor ($x$)

$$y = \beta_0 + \beta_1 x + \varepsilon$$

. . .

**Binary Predictor**: Continuous outcome variable ($y$) with a dummy ($Group$)

...
## Encoding Categories
<p class="subheader">We can use color and shape to distinguish categorical groups</p>

<br>

::: {.incremental}
- **Color encoding** maps categories to different colors
- **Shape encoding** maps categories to different shapes
- Useful for comparing groups within a scatterplot
:::

---

## Color Encoding
<p class="subheader">Each COLOR represents a continent</p>

![](../part-2-1/i/e_09.png)

. . .

*> different colors = different continents*

...
## Exercise
<p class="subheader">What type of variables are contained in `unemployment_status.csv`?</p>
...
![](i/Part_1_2_Discrete_Numerical_Exercise.png)
...
**Continuous Numerical**: quantities measurable on the reals *(Household Income in USD)*

![](i/Part_1_2_Continuous_Numerical_Exercise.png)
...
![](i/Part_1_2_Continuous_Numerical_Jitter_Boxplot_Exercise.png)
